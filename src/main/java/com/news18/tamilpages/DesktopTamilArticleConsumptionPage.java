...
public class DesktopTamilArticleConsumptionPage {
	...
	@FindBy(xpath="//div[contains(@class,'article_content_row')]//ul[contains(@class,'share')]/li[not (contains(@class,'for_'))]//a | //div[contains(@class,'pht-artcl-hd')]//div[contains(@class,'pht-artcl-share')]/a")

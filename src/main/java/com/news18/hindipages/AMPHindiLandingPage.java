...
public class AMPHindiLandingPage {
	...
	@FindBy(xpath="//div[contains(@class,'tpstatesnames')]//section/h5")
	private List<WebElement> rajyaSectionEleList;

	/*list Of elements present under rajya Section Dropdown*/
	@FindBy(xpath="//div[contains(@class,'tpstatesnames')]//section/h5[contains(@aria-expanded,'true')]//parent::section//div[contains(@class,'tpstatesnames-sublist')]//a")
...
/* Send Button in cricket Ka Test*/
	...
	public void HamburgerMenuAllSectionsNavigation(String serverType)
	{
		...
		for (int i = 1; i < hamburgerHomeSectionLnks.size()-6;i++)
		{
			...
			webDriverActions.softHighlightElement(articleBreadcrumb);
			softAssert.assertTrue(webDriverActions.softIsElementDisplayed(articleBreadcrumb,1)," Possibly element not visible " );

...
public class MobileHindiLandingPage {
	...
	@FindBy(xpath = "//div[contains(@class,'globalhd')]//a[contains(@href,'/sports/cricket/')]/ancestor::div[contains(@class,'globalhd')]/following-sibling::ul[1]//a")
	private List<WebElement> cricketArticleLnk; 

	/* List of Cricket Section Image Links in Homepage */
	@FindBy(xpath = "//div[contains(@class,'globalhd')]//a[contains(@href,'/sports/cricket/')]/ancestor::div[contains(@class,'globalhd')]/following-sibling::ul[1]//a//img")
	...
	/*News18 Minis World News BreadCrumb Division*/
	@FindBy(xpath = "//div[contains(@class,'minis')]/h1")
	private WebElement news18WorldNewsBreadcrumbDiv;
	...
	public void HamburgerMenuAllSectionsNavigation(String serverType)
	{
		...
		/* Below loop will fetch list of articles and navigate to each one by one */     
		for (int i = 2; i < hamburgerHomeSectionLnks.size()-2;i++)
		{
	...
	public void verifyNews18MinisWorldOfNewsNavigation(String serverType)
	{
		...
		webDriverActions.softHighlightElement(news18WorldNewsBreadcrumbDiv);
		softAssert.assertTrue(webDriverActions.softIsElementDisplayed(news18WorldNewsBreadcrumbDiv), "Unable to Display Element in "+currentPage);
		softAssert.assertAll("Issue Found in Homepage Body ");
	}

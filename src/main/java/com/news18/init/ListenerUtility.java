...
public class ListenerUtility extends DBUtility implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		try {
			...
			if (curClassName.contains("ParentUrls")||curClassName.contains("ChildUrls")) {
				insertIntoDBRevamp(current_className,platformName,curClassMethodName,status,lang,exception.replace("'", "\""));
			}
			else if (curClassMethodName.contains("getDBParentSitemapUrls")||curClassMethodName.contains("insertDBChildSitemapUrls")) {
				Logs.info(getClass(),"Child Urls added");
			}
			else {

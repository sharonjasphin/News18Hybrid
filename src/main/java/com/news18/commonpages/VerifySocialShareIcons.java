...
public class VerifySocialShareIcons {
	...
	public void verifySocialMediaNavigation(List<WebElement>socialShareIconsLnk,WebElement allShareIcons )
	{
		try {
			...
			webDriverActions.scrollToElement(allShareIcons);
			webDriverActions.waitForElementVisibility(allShareIcons, 10);
			webDriverActions.softHighlightElement(allShareIcons);
			...
			for(int i=0;i<socialShareIconsLnk.size();i++)  
			{
				...
				if(actual.contains("whatsapp") || actual.contains("wa.me")) {

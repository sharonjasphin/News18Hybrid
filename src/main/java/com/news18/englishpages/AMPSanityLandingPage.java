...
public class AMPSanityLandingPage {
	...
	public void verifyHamburgerMenuSectionAndIntrendsSection(String server, WebElement header,List<WebElement> section)
	{
		...
		for (int i = 0; i < section.size()-15; i++)
		{
			...
			if (response==200) {
				...
				softAssert.fail("Possibly Url is Invalid "+currentUrl);
	...
	public void verifyVideoWallArticleNavigation(String serverType)
	{
		...
		softAssert.assertTrue(webDriverActions.softIsElementDisplayed(videoWallArticleBreadcrumb,2),"Unable to Display Element "+videoWallArticleBreadcrumb +" "+currentPage);

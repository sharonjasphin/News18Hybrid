...
public class AMPLiveblogPage {
	...
	public AMPLiveblogPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[contains(@class,'story')]/h1/a[contains(@href,'live-') or contains(@href,'livenews')] | //div[contains(@class,'text')]/a[contains(@href,'live-') or contains(@href,'livenews')]")
	...
	@FindBy(xpath = "//div[contains(@class,'liveStatusIcon')]/ancestor::figure//a  |  //div[contains(@class,'liveBlog')]/ancestor::div[contains(@class,'mstory-row')]/div[contains(@class,'text')]/a ")
	...
	//PHOTOS
	public void verifyPhotoLiveblogLoadMoreNavigation(String serverType)
	{
		verifyLiveblogLoadMoreNavigation(serverType, commonLiveblogLnks);
	}

	public void verifyPhotoLiveBlogReadMoreSectionValidation(String serverType)
	{
		verifyLiveBlogReadMoreSectionValidation(serverType, commonLiveblogLnks);
	}

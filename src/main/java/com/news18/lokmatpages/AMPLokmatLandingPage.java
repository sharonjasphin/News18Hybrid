 ...
 *
 */
public class AMPLokmatLandingPage {
	...
	public AMPLokmatLandingPage(WebDriver driver) {
		this.driver = driver;
	...
	/*Header Logo*/
	@FindBy(xpath="//div/a[contains(@class,'logo')] | //header")
	private WebElement headerLogo;

	/*RajyaSeherChune Link Present on Line One Section Of Hindi Landing Page*/
	@FindBy(xpath="//div[contains(@class,'district')]//button")
	...
	@FindBy(xpath="//div[contains(@class,'nav_icon')]//button[contains(@class,'menu-btn')]")
	private WebElement hamburgerMenuLnk;

	/*list Of elements present under Hamburger Menu*/
	@FindBy(xpath="(//ul[contains(@class,'menu-list')])[2]//a[not(contains(@href,'/about-us/'))]")
	private List<WebElement> hamburgerMenuEleList;

	/*hamburger Menu Link present on homepage Of Hindi Landing Page*/
	@FindBy(xpath="//div[contains(@class,'select-language')]//label")
	private WebElement hamburgerMenuLanguageLnk;

	/*list Of elements present under Hamburger Menu*/
	@FindBy(xpath="//ul[contains(@class,'sub-menu-list')]//li/a")
	...
	//===================================Sanjeeb's Business Logics=================================
		 ...
		 */
		public void verifyHeaderLogoSection() {
			webDriverActions.waitForPageToLoad();
			String pageUrl="";

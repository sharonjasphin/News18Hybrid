...
public class DesktopGujaratiSanityLandingPage {
	...
	public void verifyPriorityPanelArticleCount() {
		...
		webDriverActions.waitForPageToLoad();
		webDriverActions.waitForElement(1000);
		System.out.println(priorityArticleLst.size());
		System.out.println(AdLink.size());
		softAssert.assertTrue(priorityArticleLst.size()==14, "Articles count do not match the pre condition and Articles count is : "+priorityPanelArticleLnk.size());

 ...
 */
public class MobileLokmatFooterGroupSitesValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void footerGroupSitesValidation () {
		pages.mobileLokmatLandingPage.verifyFooterGroupSitesSection(serverType);
	}
}

 ...
 */
public class MobileLokmatFooterLineTwoSocialValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void footerLineTwoSocialShareValidation () {
		pages.mobileLokmatLandingPage.verifyFooterLineTwoSocialSection(serverType);
	}
}

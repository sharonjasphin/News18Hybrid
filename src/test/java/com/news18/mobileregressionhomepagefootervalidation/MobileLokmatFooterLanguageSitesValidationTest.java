 ...
 */
public class MobileLokmatFooterLanguageSitesValidationTest extends MobileCommonConfig {
	...
	public void footerLanguageSitesValidation () {
		pages.mobileLokmatLandingPage.verifyFooterLanguageSitesSection(serverType);
	}
}

 ...
 */
public class MobileLokmatFooterBivagValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void footerBivagValidation () {
		pages.mobileLokmatLandingPage.verifyFooterBivagSection(serverType);
	}
}

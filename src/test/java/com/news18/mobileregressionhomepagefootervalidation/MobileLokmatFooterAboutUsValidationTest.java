 ...
 */
public class MobileLokmatFooterAboutUsValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void footerLineAboutUsValidation () {
		pages.mobileLokmatLandingPage.verifyFooterLineTwoLastlayerSection(serverType);
	}
}

 ...
 */
public class MobileLokmatFooterTrendingTopicValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void footerTrendingTopicValidation () {
		pages.mobileLokmatLandingPage.verifyFooterTrendingSection(serverType);
	}
}

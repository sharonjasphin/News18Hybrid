 ...
 */
public class AMPLokmatHeaderDistrictSectionValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void headerDistrictSection() {
		pages.ampLokmatLandingPage.verifyHeaderDistrictSection(serverType);
	}
}

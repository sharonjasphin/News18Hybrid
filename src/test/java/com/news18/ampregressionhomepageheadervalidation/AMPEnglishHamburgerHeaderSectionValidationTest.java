 ...
 */
public class AMPEnglishHamburgerHeaderSectionValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void hamburgerMenuHeaderSectionValidation () {
		pages.ampLandingPage.verfyhamburgerHeaderValidation();
	}
}

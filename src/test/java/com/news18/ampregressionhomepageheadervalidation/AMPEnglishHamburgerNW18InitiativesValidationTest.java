 ...
 */
public class AMPEnglishHamburgerNW18InitiativesValidationTest extends MobileCommonConfig {
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate News 18 Initiatives Drop down Present In Hamburger Menu of AMP English Home Page.
	 */
	@Test
	public void hamburgerNw18InitiativesValidation () {
		pages.ampLandingPage.verfyhamburgerLHSNews18Initiatives(serverType);
	}
}

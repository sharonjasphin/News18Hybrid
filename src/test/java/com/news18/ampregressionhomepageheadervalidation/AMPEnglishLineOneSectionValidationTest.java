 ...
 */
public class AMPEnglishLineOneSectionValidationTest extends MobileCommonConfig {
	...
	public void lineOneSectionValidation () {
		...
		navigateToUrl("https://www.news18.com/amp/");
		pages.ampLandingPage.verfyLineOneSection("live");
	}
}

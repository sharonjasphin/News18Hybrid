 ...
 */
public class AMPEnglishHamburgerInTrendsValidationTest extends MobileCommonConfig {
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate In Trends Drop down Present In Hamburger Menu of AMP English Home Page.
	 */
	@Test
	public void hamburgerInTrendsValidation () {
		pages.ampLandingPage.verfyhamburgerIntrendsValidation(serverType);
	}
}

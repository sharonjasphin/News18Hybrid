 ...
 */
public class AMPEnglishHamburgerChangeLangSectionValidationTest extends MobileCommonConfig {
	...
	public void hamburgerMenuHeaderChangeLanguageSectionValidation () {
		pages.ampLandingPage.verfyhamburgerChangeLanguageValidation(serverType);
	}
}

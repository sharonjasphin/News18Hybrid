 ...
 */
public class AMPEnglishHamburgerKnowUsValidationTest extends MobileCommonConfig {
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate News 18 Know Us Drop down Present In Hamburger Menu of AMP English Home Page.
	 */
	@Test
	public void hamburgerKnowUsValidation () {
		pages.ampLandingPage.verfyhamburgerLHSKnowUs(serverType);
	}
}

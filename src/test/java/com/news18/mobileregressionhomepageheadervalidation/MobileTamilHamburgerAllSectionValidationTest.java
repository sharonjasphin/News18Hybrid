 ...
 * @author DanishR
 */
public class MobileTamilHamburgerAllSectionValidationTest extends MobileCommonConfig {
...
//	@BeforeMethod
	 ...
	 */
	@Test
	public void hamburgerAllSectionValidation () {
		pages.mobileTamilLandingPage.verifyHamburgerAllSection(serverType);
	}
}

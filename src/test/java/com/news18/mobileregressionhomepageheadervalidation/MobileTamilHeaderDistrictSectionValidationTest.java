 ...
 * @author DanishR
 */
public class MobileTamilHeaderDistrictSectionValidationTest extends MobileCommonConfig {
...
//	@BeforeMethod
	 ...
	 */
	@Test
	public void headerDistrictSectionValidation () {
		pages.mobileTamilLandingPage.verifyHeaderDistrictSection(serverType);
	}
}

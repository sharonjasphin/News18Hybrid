...
public class DesktopAssamYearlyArticlesSiteMapValidation extends WebDriverActions {
	InitializePages pages;
	SoftAssert assrt = new SoftAssert();

	@Test
	public void N18_AS_ART_YEARLY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("AssamArticlesSiteMapUrl");

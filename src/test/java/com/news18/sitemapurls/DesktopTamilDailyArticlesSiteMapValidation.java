...
public class DesktopTamilDailyArticlesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_TM_ART_TODAY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("tamilArticlesSiteMapUrl");

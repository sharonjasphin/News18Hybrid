...
public class DesktopLokmatYearlyWebStoriesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_MR_WEB_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("lokmatWebStoriesSiteMapUrl");

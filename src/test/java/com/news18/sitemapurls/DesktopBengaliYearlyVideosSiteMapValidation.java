...
public class DesktopBengaliYearlyVideosSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_BN_VDO_YEARLY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("bengaliVideosSiteMapUrl");

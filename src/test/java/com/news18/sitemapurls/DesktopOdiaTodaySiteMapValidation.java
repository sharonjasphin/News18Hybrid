...
public class DesktopOdiaTodaySiteMapValidation extends WebDriverActions {
	InitializePages pages;
	SoftAssert assrt = new SoftAssert();


	@Test
	public void N18_OD_TDAY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("OdiaTodaySiteMapUrl");
		Logs.info(getClass(),"Odia xml Url is : " +url);
		try {
			try {

...
public class DesktopLokmatYearlyArticlesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_MR_ART_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("lokmatArticlesSiteMapUrl");

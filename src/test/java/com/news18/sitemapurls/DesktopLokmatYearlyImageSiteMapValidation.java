...
public class DesktopLokmatYearlyImageSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_MR_IMG_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("lokmatImageSiteMapUrl");

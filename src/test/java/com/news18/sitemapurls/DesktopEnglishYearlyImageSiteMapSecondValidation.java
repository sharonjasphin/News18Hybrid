...
public class DesktopEnglishYearlyImageSiteMapSecondValidation extends WebDriverActions {
...
//				Logs.info(getClass(),"Site Map link is : " +smList.get(i));
				...
				try {
					smArtList.parallelStream().forEach(e -> checkLinksSiteMap(e));
...
//				assrt.assertAll("Issues found in Site Map Url for "+smList.get(i)+" :");
	 ...
	 * @return 
	 */
	public void checkLinksSiteMap(String links)  {
		try {
			int responseCode=0;
			...
			if(responseCode>=404 && responseCode<500)
			{
				...
				assrt.fail(" Response code is: " +responseCode +" Issue in this Url: "+links);
			}
			else if(responseCode>500)
			{
				Logs.info(getClass(),	 "Response code is : "+responseCode+" "+links);
				failedLinks.add(links);

...
public class DesktopAssamYearlyImageSiteMapValidation extends WebDriverActions {
	InitializePages pages;
	SoftAssert assrt = new SoftAssert();

	@Test
	public void N18_AS_IMG_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("AssamImageSiteMapUrl");

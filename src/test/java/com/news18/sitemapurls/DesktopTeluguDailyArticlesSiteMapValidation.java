...
public class DesktopTeluguDailyArticlesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_TL_ART_TODAY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("teluguYearlyArticlesSiteMapUrl");

...
public class DesktopTeluguDailySiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_TL_TDY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("teluguDailySiteMapUrl");

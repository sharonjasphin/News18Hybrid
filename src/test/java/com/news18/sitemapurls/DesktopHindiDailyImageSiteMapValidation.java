...
public class DesktopHindiDailyImageSiteMapValidation extends WebDriverActions {
...
//	@BeforeMethod
	...
	@Test
	public void N18_HI_IMG() {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("hindiDailyImageSiteMap")+todaysDate()+".xml";

...
public class DesktopBengaliYearlyImageSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_BN_IMG_YEARLY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("bengaliImageSiteMapUrl");

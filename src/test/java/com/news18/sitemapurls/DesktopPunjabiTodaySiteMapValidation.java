...
public class DesktopPunjabiTodaySiteMapValidation extends WebDriverActions {
	InitializePages pages;
	SoftAssert assrt = new SoftAssert();


	@Test
	public void N18_PN_TDAY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("PunjabiTodaySiteMapUrl");

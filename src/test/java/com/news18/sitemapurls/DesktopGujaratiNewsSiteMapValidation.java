...
public class DesktopGujaratiNewsSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_GU_NEWS() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("gujaratiNewsSiteMapUrl");

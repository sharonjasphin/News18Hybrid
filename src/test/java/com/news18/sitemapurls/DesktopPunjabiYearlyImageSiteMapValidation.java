...
public class DesktopPunjabiYearlyImageSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_PN_IMG_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("PunjabiImageSiteMapUrl");

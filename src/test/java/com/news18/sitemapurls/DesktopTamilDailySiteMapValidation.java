...
public class DesktopTamilDailySiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_TM_TDY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("tamilDailySiteMapUrl");

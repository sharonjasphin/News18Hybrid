...
public class DesktopGujaratiMonthlySiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_GU_GUJ() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("gujaratiMonthlySiteMapUrl");

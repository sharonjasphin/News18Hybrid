...
public class DesktopLokmatDailySiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_MR_TDAY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("lokmatDailySiteMapUrl");

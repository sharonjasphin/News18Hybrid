...
public class DesktopKannadaDailyArticlesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_KA_ART_Daily() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("kannadaArticlesSiteMapUrl");

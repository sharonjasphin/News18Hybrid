...
public class DesktopUrduYearlyArticlesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_UR_ART_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("UrduArticlesSiteMapUrl");

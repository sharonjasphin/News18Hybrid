...
public class DesktopMalayalamYearlyImageSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_ML_IMG_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("MalayalamImageSiteMapUrl");

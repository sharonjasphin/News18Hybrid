...
public class DesktopTamilNewsSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_TM_NEWS() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("tamilNewsSiteMapUrl");

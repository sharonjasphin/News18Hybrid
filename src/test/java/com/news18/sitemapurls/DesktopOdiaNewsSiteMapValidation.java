...
public class DesktopOdiaNewsSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_OD_NEWS() {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("OdiaNewsSiteMapUrl");

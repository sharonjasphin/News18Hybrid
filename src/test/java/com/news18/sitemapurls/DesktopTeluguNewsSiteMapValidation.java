...
public class DesktopTeluguNewsSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_TL_NEWS() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("teluguNewsSiteMapUrl");

...
public class DesktopLokmatGoogleNewsSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_MR_Google_NEWS() {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("lokmatGoogleNewsSiteMapUrl");

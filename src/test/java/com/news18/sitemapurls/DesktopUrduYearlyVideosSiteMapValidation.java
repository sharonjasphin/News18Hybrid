...
public class DesktopUrduYearlyVideosSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_UR_VDO_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("UrduVideoSiteMapUrl");

...
public class DesktopUrduNewsSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_UR_NEWS() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("UrduNewsSiteMapUrl");

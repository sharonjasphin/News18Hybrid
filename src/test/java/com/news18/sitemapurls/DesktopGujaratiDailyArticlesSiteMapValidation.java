...
public class DesktopGujaratiDailyArticlesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_GU_ART_TODAY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("gujaratiArticlesSiteMapUrl");
		ArrayList<String> smList = new ArrayList<String>();
		ArrayList<String> smArtList = new ArrayList<String>();
		Logs.info(getClass(),"Gujarati xml Url is : " +url);
		try {

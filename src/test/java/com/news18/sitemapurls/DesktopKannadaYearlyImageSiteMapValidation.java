...
public class DesktopKannadaYearlyImageSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_KA_IMG_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("kannadaImageSiteMapUrl");

...
public class DesktopTamilYearlyImageSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_TM_IMG_YEARLY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("tamilImageSiteMapUrl");

...
public class DesktopMalayalamYearlyVideosSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_ML_VDO_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("MalayalamVideoSiteMapUrl");

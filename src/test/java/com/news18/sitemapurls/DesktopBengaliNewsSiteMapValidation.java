...
public class DesktopBengaliNewsSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_BN_NEWS() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("bengaliNewsSiteMapUrl");
		Logs.info(getClass(),"Telugu xml Url is : " +url);
		try {
			try {

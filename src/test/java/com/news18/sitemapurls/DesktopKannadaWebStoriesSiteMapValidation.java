...
public class DesktopKannadaWebStoriesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_KA_WEB() {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("kannadaWebStoriesSiteMapUrl");

...
public class DesktopPunjabiYearlyVideoSiteMapValidation extends WebDriverActions {
	InitializePages pages;
	GenericUtility glib=new GenericUtility();
	SoftAssert assrt = new SoftAssert();

	@Test
	public void N18_PN_VDO_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("PunjabiVideoSiteMapUrl");

...
public class DesktopUrduYearlyImageSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_UR_IMG_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("UrduImageSiteMapUrl");

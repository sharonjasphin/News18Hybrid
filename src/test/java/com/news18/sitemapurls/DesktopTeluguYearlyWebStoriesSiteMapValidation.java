...
public class DesktopTeluguYearlyWebStoriesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_TL_WEB_YEARLY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("teluguYearlyWebStoriesSiteMapUrl");

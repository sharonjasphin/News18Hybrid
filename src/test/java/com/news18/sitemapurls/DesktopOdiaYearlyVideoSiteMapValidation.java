...
public class DesktopOdiaYearlyVideoSiteMapValidation extends WebDriverActions {
	InitializePages pages;
	GenericUtility glib=new GenericUtility();
	SoftAssert assrt = new SoftAssert();

	@Test
	public void N18_OD_VDO_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("OdiaVideoSiteMapUrl");

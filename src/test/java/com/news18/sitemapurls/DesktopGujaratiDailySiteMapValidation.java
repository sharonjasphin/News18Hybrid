...
public class DesktopGujaratiDailySiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_GU_TDY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("gujaratiDailySiteMapUrl");

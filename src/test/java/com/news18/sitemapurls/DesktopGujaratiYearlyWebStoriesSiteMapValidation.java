...
public class DesktopGujaratiYearlyWebStoriesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_GU_WEB_YEARLY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("gujaratiWebStoriesSiteMapUrl");

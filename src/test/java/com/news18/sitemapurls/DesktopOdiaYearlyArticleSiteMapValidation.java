...
public class DesktopOdiaYearlyArticleSiteMapValidation extends WebDriverActions {
	InitializePages pages;
	GenericUtility glib=new GenericUtility();
	SoftAssert assrt = new SoftAssert();

	@Test
	public void N18_OD_ART_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("OdiaArticlesSiteMapUrl");

...
public class DesktopTamilYearlyVideosSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_TM_VDO_YEARLY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("tamilVideosSiteMapUrl");
		...
		Logs.info(getClass(),"Tamil xml Url is : " +url1);
		try {

...
public class DesktopLokmatYearlyVideosSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_MR_VDO_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("lokmatVideosSiteMapUrl");

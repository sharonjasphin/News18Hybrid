...
public class DesktopAssamTodaySiteMapValidation extends WebDriverActions {
	InitializePages pages;
	SoftAssert assrt = new SoftAssert();


	@Test
	public void N18_AS_TDAY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("AssamTodaySiteMapUrl");
		Logs.info(getClass(),"Assam xml Url is : " +url);
		try {
			try {

...
public class DesktopBengaliDailySiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_BN_TDY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("bengaliDailySiteMapUrl");

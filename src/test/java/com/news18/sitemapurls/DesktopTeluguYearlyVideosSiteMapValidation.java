...
public class DesktopTeluguYearlyVideosSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_TL_VDO_YEARLY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("teluguYearlyVideosSiteMapUrl");

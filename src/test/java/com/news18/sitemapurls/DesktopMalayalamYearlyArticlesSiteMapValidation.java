...
public class DesktopMalayalamYearlyArticlesSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_ML_ART_Yearly() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("MalayalamArticlesSiteMapUrl");

...
public class DesktopPunjabiNewsSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_KA_NEWS() {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("PunjabiNewsSiteMapUrl");

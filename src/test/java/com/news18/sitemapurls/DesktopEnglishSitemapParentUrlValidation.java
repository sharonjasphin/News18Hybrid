...
public class DesktopEnglishSitemapParentUrlValidation extends WebDriverActions {
	...
	@Test(priority = -1)
	public void englishSiteMapParentUrlsStatusCodeValidation() throws Throwable {
//		String url = fileUtility.readDataFromPropertyFile("englishDailySiteMapUrl")+todaysDate()+".xml";

...
public class DesktopUrduTodaySiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_UR_TDAY() throws IOException {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("UrduTodaySiteMapUrl");
		Logs.info(getClass(),"Urdu xml Url is : " +url);
		try {
			try {

...
public class DesktopMalayalamNewsSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_ML_NEWS() {
		ArrayList<String> smDailyList = new ArrayList<String>();
		String url = fileUtility.readDataFromPropertyFile("MalayalamNewsSiteMapUrl");

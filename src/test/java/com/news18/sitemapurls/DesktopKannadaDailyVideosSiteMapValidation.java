...
public class DesktopKannadaDailyVideosSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_KA_VDO_TODAY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("kannadaVideosSiteMapUrl");

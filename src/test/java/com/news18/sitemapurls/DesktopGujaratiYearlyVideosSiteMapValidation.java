...
public class DesktopGujaratiYearlyVideosSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_GU_VDO_YEARLY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("gujaratiVideosSiteMapUrl");

...
public class DesktopGujaratiYearlyImageSiteMapValidation extends WebDriverActions {
	...
	@Test
	public void N18_GU_IMG_YEARLY() throws IOException {
		String url = fileUtility.readDataFromPropertyFile("gujaratiImageSiteMapUrl");

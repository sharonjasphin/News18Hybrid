 ...
 */
public class MobileHindiRevampCategoryFooterNationLPWidgetTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void nationArticleVerifyFooterFirstLayerSection () {
	 ...
	 */
	@Test
	public void nationArticleVerifyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneNationLink();
	 ...
	 */
	@Test
	public void nationArticleVerifyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneNationLink();
	 ...
	 */
	@Test
	public void nationArticleVrifyFooterStickySection () {

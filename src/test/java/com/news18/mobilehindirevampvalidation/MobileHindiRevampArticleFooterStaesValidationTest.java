 ...
 */
public class MobileHindiRevampArticleFooterStaesValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void statesSectionArticleVerifyFooterFirstLayerSection () {
	 ...
	 */
	@Test
	public void statesSectionArticleVerifyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneStatesLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();
	 ...
	 */
	@Test
	public void statesSectionArticleVerifyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneStatesLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();
	 ...
	 */
	@Test
	public void statesSectionArticleVerifyFooterStickySection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneStatesLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();

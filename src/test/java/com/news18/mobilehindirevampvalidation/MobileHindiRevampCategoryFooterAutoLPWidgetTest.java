 ...
 */
public class MobileHindiRevampCategoryFooterAutoLPWidgetTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void autoArticleVerifyFooterFirstLayerSection () {
//		navigateToUrl("https://betahindirev:wdHj4PJxs0fHoEIBUHZ@beta-hindi-revamp.news18.com/");
	 ...
	 */
	@Test
	public void autoArticleVerifyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnAutoLink();
	 ...
	 */
	@Test
	public void autoArticleVerifyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnAutoLink();
	 ...
	 */
	@Test
	public void autoArticleVrifyFooterStickySection () {
		pages.mobileHindiRevampLandingPage.clickOnAutoLink();

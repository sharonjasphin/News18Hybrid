 ...
 */
public class MobileHindiRevampPhotoGalleryFooterCareerValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void careerPhotoArticleVerifyFooterFirstLayerSection () {
	 ...
	 */
	@Test
	public void careerPhotoArticleVerfyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneCareerLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void careerPhotoArticleVerfyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneCareerLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

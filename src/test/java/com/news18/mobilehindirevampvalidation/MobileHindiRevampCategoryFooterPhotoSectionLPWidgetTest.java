 ...
 */
public class MobileHindiRevampCategoryFooterPhotoSectionLPWidgetTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void photoSectionArticleVerifyFooterFirstLayerSection () {
//		navigateToUrl("https://betahindirev:wdHj4PJxs0fHoEIBUHZ@beta-hindi-revamp.news18.com/");
	 ...
	 */
	@Test
	public void photoSectionArticleVerifyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOnePhotoLink();
	 ...
	 */
	@Test
	public void photoSectionArticleVerifyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOnePhotoLink();
	 ...
	 */
	@Test
	public void photoSectionArticleVrifyFooterStickySection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOnePhotoLink();

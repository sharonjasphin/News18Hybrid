 ...
 */
public class MobileHindiRevampArticleFooterLatestValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void latestSectionArticleVerfyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneLatestSectionLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();
	 ...
	 */
	@Test
	public void latestSectionArticleVerfyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneLatestSectionLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();
		 ...
		 */
		@Test
		public void latestSectionArticleVerfyFooterStickySection () {
			pages.mobileHindiRevampLandingPage.clickOnLineOneLatestSectionLink();
			pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();

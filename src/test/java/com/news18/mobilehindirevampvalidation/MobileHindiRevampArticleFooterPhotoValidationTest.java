 ...
 */
public class MobileHindiRevampArticleFooterPhotoValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void photoSectionArticleVerfyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOnePhotoLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();
	 ...
	 */
	@Test
	public void photoSectionArticleVerfyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOnePhotoLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();
	 ...
	 */
	@Test
	public void photoSectionArticleVerfyFooterStickySection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOnePhotoLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();

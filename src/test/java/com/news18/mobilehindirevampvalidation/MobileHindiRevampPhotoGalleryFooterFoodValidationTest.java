 ...
 */
public class MobileHindiRevampPhotoGalleryFooterFoodValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void foodPhotoArticleVerifyFooterFirstLayerSection () {
	 ...
	 */
	@Test
	public void foodPhotoArticleVerifyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneFoodLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void foodPhotoArticleVerifyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneFoodLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void foodPhotoArticleVerifyFooterStickySection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneFoodLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

 ...
 */
public class MobileHindiRevampArticleFooterCareerValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void careerArticleVerfyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneCareerLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();
	 ...
	 */
	@Test
	public void careerArticleVerfyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneCareerLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();
	 ...
	 */
	@Test
	public void careerArticleVerfyFooterStickySection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneCareerLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstArticle();

 ...
 */
public class MobileHindiRevampPhotoGalleryFooterHealthValidationTest extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void healthPhotoArticleVerifyFooterFirstLayerSection () {
	 ...
	 */
	@Test
	public void healthPhotoArticleVerifyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneHealthLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void healthPhotoArticleVerifyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneHealthLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void healthPhotoArticleVerifyFooterStickySection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneHealthLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

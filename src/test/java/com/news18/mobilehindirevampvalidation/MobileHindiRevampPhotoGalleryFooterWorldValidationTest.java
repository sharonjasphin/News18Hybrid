 ...
 */
public class MobileHindiRevampPhotoGalleryFooterWorldValidationTest extends MobileCommonConfig {
	//=============================================== Photo Article =========================================
	 ...
	 */
	@Test
	public void worldSectionPhotoArticleVerifyFooterFirstLayerSection () {
	 ...
	 */
	@Test
	public void worldSectionPhotoArticleVerifyFooterLiveTvSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneWorldLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void worldSectionPhotoArticleVerifyFooterLastLayerSection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneWorldLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void worldSectionPhotoArticleVerifyFooterStickySection () {
		pages.mobileHindiRevampLandingPage.clickOnLineOneWorldLink();
		pages.mobileHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

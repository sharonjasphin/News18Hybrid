 ...
 */
public class AMPEnglishCategoryArticleBodyOpinionSectionValidation extends MobileCommonConfig{
	/**
	 * @author Danish
	 * This method is used to Validate the navigation of Photogallery Article
	 */
	@Test
	public void cat_Landing_AMP_10_OpinionSectionPhotogalleryArticle() {
	 ...
	 */
	@Test
	public void cat_Landing_AMP_10_OpinionSectionPhotogalleryImg() {
		pages.ampLandingPage.clickOnLineOneOpinionLink();
	 ...
	 */
	@Test
	public void cat_Landing_AMP_12_OpinionSectionLiveTv() {
		pages.ampLandingPage.clickOnLineOneOpinionLink();
	 ...
	 */
	@Test
	public void  cat_Landing_AMP_08_OpinionVideoWallDownAd() {
		pages.ampLandingPage.clickOnLineOneOpinionLink();
	 ...
	 */
	@Test
	public void cat_Landing_AMP_09_OpinionVideoWallArticle() {
		pages.ampLandingPage.clickOnLineOneOpinionLink();
	 ...
	 */
	@Test 
	public void cat_Landing_AMP_09_OpinionVideoWallImg() {
		pages.ampLandingPage.clickOnLineOneOpinionLink();

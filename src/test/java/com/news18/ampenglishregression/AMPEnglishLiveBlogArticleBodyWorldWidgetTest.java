 ...
 */
public class AMPEnglishLiveBlogArticleBodyWorldWidgetTest extends MobileCommonConfig
{
	/**
	 * @author VipinKumarGawande
	...
	{
		pages.ampLandingPage.clickOnLineOneWorldLink();
		pages.ampLiveblogPage.verifyWorldLiveblogLoadMoreNavigation(serverType);
	}
	...
	{
		pages.ampLandingPage.clickOnLineOneWorldLink();
		pages.ampLiveblogPage.verifyWorldLiveBlogReadMoreSectionValidation(serverType);
	}
}

 ...
 */
public class AMPEnglishCategoryArticleBodyPoliticsSectionValidation extends MobileCommonConfig{
	/**
	 * @author Danish
	 * This method is used to Validate the navigation of Photogallery Article
	 */
	@Test
	public void cat_Landing_AMP_10_PoliticsSectionPhotogalleryArticle() {
	 ...
	 */
	@Test
	public void cat_Landing_AMP_10_PoliticsSectionPhotogalleryImg() {
		pages.ampLandingPage.clickOnLineOnePoliticsLink();
	 ...
	 */
	@Test
	public void cat_Landing_AMP_12_PoliticsSectionLiveTv() {
		pages.ampLandingPage.clickOnLineOnePoliticsLink();
	 ...
	 */
	@Test
	public void  cat_Landing_AMP_08_PoliticsVideoWallDownAd() {
		pages.ampLandingPage.clickOnLineOnePoliticsLink();
	 ...
	 */
	@Test
	public void cat_Landing_AMP_09_PoliticsVideoWallArticle() {
		pages.ampLandingPage.clickOnLineOnePoliticsLink();
	 ...
	 */
	@Test 
	public void cat_Landing_AMP_09_PoliticsVideoWallImg() {
		pages.ampLandingPage.clickOnLineOnePoliticsLink();

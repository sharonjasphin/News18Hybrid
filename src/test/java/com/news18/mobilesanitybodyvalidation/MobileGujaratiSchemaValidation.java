 ...
 */
public class MobileGujaratiSchemaValidation extends DesktopCommonConfig{
	...
	public void gujaratiArticlePage() throws IOException, InterruptedException {
		pages.mobileGujaratiSanityLandingPage.clickOnFirstArticleHomePage(serverType);
		pages.structuredSchemaValidation.schemaValidation();
	}
	...
	public void gujaratiPhotoGalleryPage() throws IOException, InterruptedException {
		pages.mobileGujaratiSanityLandingPage.clickOnPhotoSection(serverType);
		pages.structuredSchemaValidation.schemaValidation();	
	}
	...
	public void gujaratiLiveblogPage() throws IOException, InterruptedException {
		pages.mobileGujaratiSanityLandingPage.clickOnLiveBlogArticleHomePage(serverType);
		pages.structuredSchemaValidation.schemaValidation();	
	}
	...
	public void gujaratiFirstArticleVideoArticle() throws IOException, InterruptedException {
		pages.mobileGujaratiSanityLandingPage.navigateToVideosSection(serverType);
		pages.structuredSchemaValidation.schemaValidation();	
	}

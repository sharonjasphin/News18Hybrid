 ...
 */
public class MobileEnglishTopicsLinks extends MobileCommonConfig {
...
//	@BeforeMethod
	 ...
	 */
	@Test
	public void englishHomePageTopicLinks() throws Throwable {
		pages.mobileSanityLandingPage.topicsLinks(serverType);
	}
}

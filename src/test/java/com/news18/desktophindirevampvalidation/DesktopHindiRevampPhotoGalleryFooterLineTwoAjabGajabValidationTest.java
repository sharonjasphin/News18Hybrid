 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterLineTwoAjabGajabValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void ajabGajabPhotoArticlefooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void ajabGajabPhotoArticlefooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoAjabGajabSectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void ajabGajabPhotoArticlefooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoAjabGajabSectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

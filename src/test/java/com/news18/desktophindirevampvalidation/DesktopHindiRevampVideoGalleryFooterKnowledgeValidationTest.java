 ...
 */
public class DesktopHindiRevampVideoGalleryFooterKnowledgeValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void knowledgeVideoArticlefooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void knowledgeVideoArticlefooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneKnowledgeLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();
	 ...
	 */
	@Test
	public void knowledgeVideoArticlefooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneKnowledgeLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();

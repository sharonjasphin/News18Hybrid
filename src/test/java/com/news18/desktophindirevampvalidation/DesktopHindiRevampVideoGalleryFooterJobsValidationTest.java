 ...
 */
public class DesktopHindiRevampVideoGalleryFooterJobsValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void jobsVideoArticlefooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void jobsVideoArticlefooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneJobsLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();
	 ...
	 */
	@Test
	public void jobsVideoArticlefooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneJobsLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();

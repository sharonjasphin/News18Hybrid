 ...
 */
public class DesktopHindiRevampVideoGalleryFooterTechValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void techVideoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void techVideoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneTechLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();
	 ...
	 */
	@Test
	public void techVideoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneTechLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();

 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterJobsValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void jobsPhotoArticlefooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void jobsPhotoArticlefooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneJobsLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void jobsPhotoArticlefooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneJobsLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterNationValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void nationPhotoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void nationPhotoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneNationLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void nationPhotoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneNationLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

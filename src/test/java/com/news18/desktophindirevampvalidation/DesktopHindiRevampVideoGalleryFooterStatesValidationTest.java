 ...
 */
public class DesktopHindiRevampVideoGalleryFooterStatesValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void statesVideoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void statesVideoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneStatesLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();
	 ...
	 */
	@Test
	public void statesVideoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneStatesLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();

 ...
 */
public class DesktopHindiRevampVideoGalleryFooterMobileValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void mobileVideoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void mobileVideoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMobileLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();
	 ...
	 */
	@Test
	public void mobileVideoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMobileLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();

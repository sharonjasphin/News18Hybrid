...
public class DesktopHindiRevampArticleFooterLineTwoAstrologyValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void astrologyArticlefooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void astrologyArticlefooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoAstrologySectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnLineTwoPriorityFirstArticle();
	 ...
	 */
	@Test
	public void astrologyArticlefooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoAstrologySectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnLineTwoPriorityFirstArticle();

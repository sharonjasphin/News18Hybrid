 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterTechValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void techPhotoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void techPhotoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneTechLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void techPhotoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneTechLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

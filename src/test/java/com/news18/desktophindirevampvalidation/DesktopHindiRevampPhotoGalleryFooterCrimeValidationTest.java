 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterCrimeValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void crimeWidgetPhotoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void crimeWidgetPhotoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneCrimeSectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void crimeWidgetPhotoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneCrimeSectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

 ...
 */
public class DesktopHindiRevampArticleHeaderMoneyValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void moneyArticleLineOneSectionValidation () {
	 ...
	 */
	@Test
	public void moneyArticleLineOneSectionArticleValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMoneyLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnFirstMoneyArticle();
	 ...
	 */
	@Test
	public void moneyArticleLineTwoSectionValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMoneyLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnFirstMoneyArticle();
	 ...
	 */
	@Test
	public void moneyArticleLineOneSectionRajyaChuneValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMoneyLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnFirstMoneyArticle();
	 ...
	 */
	@Test
	public void moneyArticleHeaderChangeLanguageValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMoneyLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnFirstMoneyArticle();
	 ...
	 */
	@Test
	public void moneyArticleHeaderSearchButtonValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMoneyLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnFirstMoneyArticle();
	 ...
	 */
	@Test
	public void moneyArticleHeaderLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMoneyLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnFirstMoneyArticle();
	 ...
	 */
	@Test
	public void moneyArticleHeaderDownloadAppValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMoneyLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnFirstMoneyArticle();
	 ...
	 */
	@Test
	public void moneyArticleHeaderSocialShareValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMoneyLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnFirstMoneyArticle();

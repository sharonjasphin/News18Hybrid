 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterMobileValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void mobilePhotoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void mobilePhotoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMobileLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void mobilePhotoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneMobileLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

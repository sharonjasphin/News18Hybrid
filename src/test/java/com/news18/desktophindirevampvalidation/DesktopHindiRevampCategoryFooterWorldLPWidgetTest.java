 ...
 */
public class DesktopHindiRevampCategoryFooterWorldLPWidgetTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void worldWidgetFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void worldWidgetFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneWorldLink();
	 ...
	 */
	@Test
	public void worldWidgetFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneWorldLink();

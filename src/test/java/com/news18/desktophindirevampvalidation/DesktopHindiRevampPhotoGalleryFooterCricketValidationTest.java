 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterCricketValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void cricketWidgetPhotoArticleFooterFirstLayerValidation () {
	...
	@Test
	public void cricketWidgetPhotoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneCricketLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCricketSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void cricketWidgetPhotoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneCricketLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCricketSectionFirstPhotoArticle();

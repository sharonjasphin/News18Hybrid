 ...
 */
public class DesktopHindiRevampCategoryFooterBlogsLPWidgetTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void blogsWidgetFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void blogsWidgetFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoBlogLink();
	 ...
	 */
	@Test
	public void blogsWidgetFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoBlogLink();

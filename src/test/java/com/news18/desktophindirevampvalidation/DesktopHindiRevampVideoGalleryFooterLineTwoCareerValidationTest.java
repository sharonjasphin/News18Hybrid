 ...
 */
public class DesktopHindiRevampVideoGalleryFooterLineTwoCareerValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void careerPhotoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void careerPhotoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoCareerSectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void careerPhotoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoCareerSectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

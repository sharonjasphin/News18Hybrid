 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterKnowledgeValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void knowledgePhotoArticlefooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void knowledgePhotoArticlefooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneKnowledgeLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void knowledgePhotoArticlefooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneKnowledgeLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

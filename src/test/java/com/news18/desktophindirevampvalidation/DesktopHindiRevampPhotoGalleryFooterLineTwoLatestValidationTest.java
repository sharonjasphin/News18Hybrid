 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterLineTwoLatestValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void LatestSectionPhotoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void LatestSectionPhotoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoLatestSectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void LatestSectionPhotoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoLatestSectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

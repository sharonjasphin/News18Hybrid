 ...
 */
public class DesktopHindiRevampCategoryFooterJobsLPWidgetTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void jobsWidgetFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void jobsWidgetFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneJobsLink();
	 ...
	 */
	@Test
	public void jobsWidgetFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneJobsLink();

 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterLineTwoPhotoValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void PhotoWidgetPhotoArticleFooterFirstLayerValidation () {
	...
	@Test
	public void PhotoWidgetPhotoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoPhotoLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnPhotoSectionFirstArticle();
	 ...
	 */
	@Test
	public void PhotoWidgetPhotoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoPhotoLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnPhotoSectionFirstArticle();

 ...
 */
public class DesktopHindiRevampCategoryFooterTechLPWidgetTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void techWidgetFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void techWidgetFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneTechLink();
	 ...
	 */
	@Test
	public void techWidgetFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneTechLink();

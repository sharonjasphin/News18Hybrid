 ...
 */
public class DesktopHindiRevampCategoryFooterStatesLPWidgetTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void statesWidgetFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void statesWidgetFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneStatesLink();
	 ...
	 */
	@Test
	public void statesWidgetFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneStatesLink();

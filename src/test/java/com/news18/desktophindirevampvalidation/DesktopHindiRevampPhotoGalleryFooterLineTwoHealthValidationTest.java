 ...
 */
public class DesktopHindiRevampPhotoGalleryFooterLineTwoHealthValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void healthPhotoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void healthPhotoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoHealthLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();
	 ...
	 */
	@Test
	public void healthPhotoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoHealthLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstPhotoArticle();

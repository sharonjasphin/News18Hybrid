 ...
 */
public class DesktopHindiRevampVideoGalleryFooterLineTwoAstrologyValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void astrologyVideoArticlefooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void astrologyVideoArticlefooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoAstrologySectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();
	 ...
	 */
	@Test
	public void astrologyVideoArticlefooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineTwoAstrologySectionLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();

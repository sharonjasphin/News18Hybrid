 ...
 */
public class DesktopHindiRevampVideoGalleryFooterWorldValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void worldVideoArticleFooterFirstLayerValidation () {
	 ...
	 */
	@Test
	public void worldVideoArticleFooterLiveTvValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneWorldLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();
	 ...
	 */
	@Test
	public void worldVideoArticleFooterLastLayerValidation () {
		pages.desktopHindiRevampLandingPage.clickOnLineOneWorldLink();
		pages.desktopHindiRevampArticleConsumptionPage.clickOnCommonSectionFirstVideoArticle();

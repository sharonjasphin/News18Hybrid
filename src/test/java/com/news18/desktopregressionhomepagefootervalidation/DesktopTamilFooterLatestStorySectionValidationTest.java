 ...
 */
public class DesktopTamilFooterLatestStorySectionValidationTest extends DesktopCommonConfig {
	...
	public void footerLatestSectionValidation () {
		pages.desktopTamilLandingPage.verifyFooterLatestSection(serverType);
	}
}

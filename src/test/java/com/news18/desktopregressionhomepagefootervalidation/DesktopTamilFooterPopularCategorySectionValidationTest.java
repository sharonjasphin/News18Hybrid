 ...
 */
public class DesktopTamilFooterPopularCategorySectionValidationTest extends DesktopCommonConfig {
	...
	public void footerPopularCategorySectionValidation () {
		pages.desktopTamilLandingPage.verifyFooterPopularCategorySection(serverType);
	}
}

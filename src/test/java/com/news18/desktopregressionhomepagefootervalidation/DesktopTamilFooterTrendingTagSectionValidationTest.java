 ...
 */
public class DesktopTamilFooterTrendingTagSectionValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void footerTrendingTagSectionValidation () {
		pages.desktopTamilLandingPage.verifyFooterTrendingTagSection(serverType);
	}
}

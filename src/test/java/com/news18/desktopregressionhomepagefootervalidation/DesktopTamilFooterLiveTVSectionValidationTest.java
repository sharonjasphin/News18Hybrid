 ...
 */
public class DesktopTamilFooterLiveTVSectionValidationTest extends DesktopCommonConfig {
	...
	public void footerLastLayerSocialSectionValidation () {
		pages.desktopTamilLandingPage.verifyFooterLiveTVSection(serverType);
	}
}

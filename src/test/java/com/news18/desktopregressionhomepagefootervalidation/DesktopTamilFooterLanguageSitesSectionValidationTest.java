 ...
 */
public class DesktopTamilFooterLanguageSitesSectionValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void footerLanguageSitesSectionValidation () {
		pages.desktopTamilLandingPage.verifyFooterLanguageSitesSection();
	}
}

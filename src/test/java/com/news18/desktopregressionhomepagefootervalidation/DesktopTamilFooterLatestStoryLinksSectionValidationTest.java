 ...
 */
public class DesktopTamilFooterLatestStoryLinksSectionValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void footerLatestStoryLinksSectionValidation () {
		pages.desktopTamilLandingPage.verifyFooterLatestStorySection(serverType);
	}
}

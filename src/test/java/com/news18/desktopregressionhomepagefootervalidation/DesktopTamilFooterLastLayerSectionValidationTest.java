 ...
 */
public class DesktopTamilFooterLastLayerSectionValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void footerLastLayerSectionValidation () {
		pages.desktopTamilLandingPage.verifyFooterLastLayerSection();
	}
}

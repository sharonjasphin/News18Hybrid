 ...
 */
public class DesktopTamilLineOneChooseYourDistrictValidationTest extends DesktopCommonConfig {
	...
	public void lineTwoChooseYourDistrictValidation () {
		pages.desktopTamilLandingPage.verifyLineOneSectionRajyaSeherChune(serverType);
	}
}

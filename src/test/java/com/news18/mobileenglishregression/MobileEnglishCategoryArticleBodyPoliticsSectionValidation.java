 ...
 */
public class MobileEnglishCategoryArticleBodyPoliticsSectionValidation extends MobileCommonConfig{
	/**
	 * @author Danish
	 * This method is used to Validate the navigation of Photogallery Article
	 */
	@Test
	public void cat_Landing_Mweb_10_PoiliticsSectionPhotogalleryArticle() {
	 ...
	 */
	@Test
	public void cat_Landing_Mweb_10_PoiliticsSectionPhotogalleryImg() {
		pages.mobileLandingPage.clickOnLineOnePoliticsLink();
	 ...
	 */
	@Test
	public void cat_Landing_Mweb_12_PoiliticsSectionLiveTv() {
		pages.mobileLandingPage.clickOnLineOnePoliticsLink();

 ...
 */
public class MobileEnglishLiveBlogArticleBodyBusinessWidgetTest extends MobileCommonConfig
{
	/**
	 * @author VipinKumarGawande
	...
	{
		pages.mobileLandingPage.clickOnLineOneBusinessLink();
		pages.mobileLiveblogPage.verifyBusinessLiveblogLoadMoreNavigation(serverType);
	}
	...
	{
		pages.mobileLandingPage.clickOnLineOneBusinessLink();
		pages.mobileLiveblogPage.verifyBusinessLiveBlogReadMoreSectionValidation(serverType);
	}
}

 ...
 */
public class MobileEnglishHomePageHeaderHamburgerGroupSitesWidgetValidation extends MobileCommonConfig {
	 ...
	 */
	@Test
	public void hamburgerLHSGroupSitesWidgetValidation () {
	 ...
	 */
	@Test
	public void hamburgerHeaderWidgetValidation () {

		pages.mobileLandingPage.verfyhamburgerHeaderValidation(serverType);
	}
}

 ...
 */
public class MobileEnglishPhotogalleryArticleBodyCricketWidgetTest extends MobileCommonConfig
{
	/**
	 * @author VipinKumarGawande
	...
	{
		pages.mobileLandingPage.clickOnLineOneCricketLink();
		pages.mobilePhotoGalleryConsumptionPage.verifyCricketSectionPhotoArticleCountValidation(serverType);
	}
	...
	{
		pages.mobileLandingPage.clickOnLineOneCricketLink();
		pages.mobilePhotoGalleryConsumptionPage.verifyCricketSectionPhotoAdsBetweenArticleValidation(serverType);
	}

 ...
 */
public class MobileEnglishCategoryArticleBodyLatestSectionValidation extends MobileCommonConfig{
	/**
	 * @author Danish
	 * This method is used to Validate the navigation of Photogallery Article
	 */
	@Test
	public void cat_Landing_Mweb_10_LatestSectionPhotogalleryArticle() {
	 ...
	 */
	@Test
	public void cat_Landing_Mweb_10_LatestSectionPhotogalleryImg() {
		pages.mobileLandingPage.clickOnLineOneLatestLink();
	 ...
	 */
	@Test
	public void cat_Landing_Mweb_12_LatestSectionLiveTv() {
		pages.mobileLandingPage.clickOnLineOneLatestLink();

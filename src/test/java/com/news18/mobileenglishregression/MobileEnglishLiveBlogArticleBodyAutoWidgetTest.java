 ...
 */
public class MobileEnglishLiveBlogArticleBodyAutoWidgetTest extends MobileCommonConfig
{
	/**
	 * @author VipinKumarGawande
	...
	{
		pages.mobileLandingPage.clickOnLineOneAutoLink();
		pages.mobileLiveblogPage.verifyAutoLiveblogLoadMoreNavigation(serverType);
	}
	...
	{
		pages.mobileLandingPage.clickOnLineOneAutoLink();
		pages.mobileLiveblogPage.verifyAutoLiveBlogReadMoreSectionValidation(serverType);
	}
}

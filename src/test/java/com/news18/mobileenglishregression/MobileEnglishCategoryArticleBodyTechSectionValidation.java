 ...
 */
public class MobileEnglishCategoryArticleBodyTechSectionValidation extends MobileCommonConfig{
	/**
	 * @author Danish
	 * This method is used to Validate the navigation of Photogallery Article
	 */
	@Test
	public void cat_Landing_Mweb_10_TechSectionPhotogalleryArticle() {
	 ...
	 */
	@Test
	public void cat_Landing_Mweb_10_TechSectionPhotogalleryImg() {
		pages.mobileLandingPage.clickOnLineOneTechLink();
	 ...
	 */
	@Test
	public void cat_Landing_Mweb_12_TechSectionLiveTv() {
		pages.mobileLandingPage.clickOnLineOneTechLink();

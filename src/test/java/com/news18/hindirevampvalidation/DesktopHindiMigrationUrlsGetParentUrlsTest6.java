...
public class DesktopHindiMigrationUrlsGetParentUrlsTest6 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		revampUrls = dbGetHindiRevampUrls(50000,10000);
	}


	@DataProvider(name = "hindiRevampUrls6")
	...
	@Test(dataProvider = "hindiRevampUrls6")

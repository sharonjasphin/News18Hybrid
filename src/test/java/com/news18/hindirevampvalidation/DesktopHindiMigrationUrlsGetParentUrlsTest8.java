...
public class DesktopHindiMigrationUrlsGetParentUrlsTest8 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		revampUrls = dbGetHindiRevampUrls(350000,50000);
	}


	@DataProvider(name = "hindiRevampUrls8")
	...
	@Test(dataProvider = "hindiRevampUrls8")

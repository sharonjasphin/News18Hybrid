...
public class DesktopHindiMigrationUrlsGetParentUrlsTest13 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		revampUrls = dbGetHindiRevampUrls(650000,50000);
	}


	@DataProvider(name = "hindiRevampUrls13")
	...
	@Test(dataProvider = "hindiRevampUrls13")

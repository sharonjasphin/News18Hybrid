...
public class DesktopHindiMigrationUrlsGetParentUrlsTest11 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		revampUrls = dbGetHindiRevampUrls(550000,50000);
	}


	@DataProvider(name = "hindiRevampUrls11")
	...
	@Test(dataProvider = "hindiRevampUrls11")

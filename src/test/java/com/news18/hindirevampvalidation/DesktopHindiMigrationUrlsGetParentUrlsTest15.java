...
public class DesktopHindiMigrationUrlsGetParentUrlsTest15 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		revampUrls = dbGetHindiRevampUrls(750000,50000);
	}


	@DataProvider(name = "hindiRevampUrls15")
	...
	@Test(dataProvider = "hindiRevampUrls15")

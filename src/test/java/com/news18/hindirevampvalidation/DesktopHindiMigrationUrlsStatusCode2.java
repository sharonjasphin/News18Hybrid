...
public class DesktopHindiMigrationUrlsStatusCode2 extends WebDriverActions {
	...
	public void validateHindiRevampUrlStatusCode() throws Throwable
	{
		...
		String query="SELECT urls FROM hindi_revamp_urls limit 100000,100000; ";
	...
	public void checkLinks1(String url)  {
		...
		try {
			...
			if (responseCode>200) {
				Logs.error(getClass(), responseCode + "--------------- "  +url);

...
public class DesktopHindiMigrationUrlsGetParentUrlsTest12 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		revampUrls = dbGetHindiRevampUrls(600000,50000);
	}


	@DataProvider(name = "hindiRevampUrls12")
	...
	@Test(dataProvider = "hindiRevampUrls12")

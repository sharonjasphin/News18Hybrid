...
public class DesktopHindiMigrationUrlsGetStatusCodeJsoup4 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		...
		String query="select childurl from hindi_migration_urls where childurl not like '%instagram%' limit 53763,17921; ";

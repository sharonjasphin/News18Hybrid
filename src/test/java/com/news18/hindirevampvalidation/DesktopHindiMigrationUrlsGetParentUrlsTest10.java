...
public class DesktopHindiMigrationUrlsGetParentUrlsTest10 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		revampUrls = dbGetHindiRevampUrls(500000,50000);
	}


	@DataProvider(name = "hindiRevampUrls10")
	...
	@Test(dataProvider = "hindiRevampUrls10")

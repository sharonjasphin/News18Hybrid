...
public class DesktopHindiMigrationUrlsGetParentUrlsTest2 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		revampUrls = dbGetHindiRevampUrls(100000,100000);
	}


	@DataProvider(name = "hindiRevampUrls2")
	...
	@Test(dataProvider = "hindiRevampUrls2")

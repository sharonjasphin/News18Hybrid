...
public class DesktopHindiMigrationUrlsGetParentUrlsTest7 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		revampUrls = dbGetHindiRevampUrls(525000,15000);
	}


	@DataProvider(name = "hindiRevampUrls7")
	...
	@Test(dataProvider = "hindiRevampUrls7")

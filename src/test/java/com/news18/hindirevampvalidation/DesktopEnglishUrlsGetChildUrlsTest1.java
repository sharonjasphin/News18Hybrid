...
public class DesktopEnglishUrlsGetChildUrlsTest1 extends WebDriverActions {
...
//	}	
	...
	public void beforeClassConfig() throws Throwable {
		englishUrls = dbGetHindiRevampUrls(55000,5000);
	}


	@DataProvider(name = "englishUrls1")
	...
	@Test(dataProvider = "englishUrls1")

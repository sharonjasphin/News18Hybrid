...
public class DesktopHindiMigrationUrlsGetParentUrlsTest16 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		revampUrls = dbGetHindiRevampUrls(800000,60000);
	}


	@DataProvider(name = "hindiRevampUrls16")
	...
	@Test(dataProvider = "hindiRevampUrls16")

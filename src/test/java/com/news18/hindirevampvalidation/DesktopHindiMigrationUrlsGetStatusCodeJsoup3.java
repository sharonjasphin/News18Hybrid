...
public class DesktopHindiMigrationUrlsGetStatusCodeJsoup3 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		...
		String query="select childurl from hindi_migration_urls where childurl not like '%instagram%' limit 35842,17921; ";

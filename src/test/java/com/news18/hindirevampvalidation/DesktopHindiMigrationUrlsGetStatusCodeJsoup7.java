...
public class DesktopHindiMigrationUrlsGetStatusCodeJsoup7 extends WebDriverActions {
	...
	public void beforeClassConfig() throws Throwable {
		...
		String query="select childurl from hindi_migration_urls where childurl not like '%instagram%' limit 107526,17921; ";

 ...
 */
public class DesktopEnglishLiveBlogArticleHeaderEducationValidationTest extends DesktopCommonConfig {
...
//======================================Article================================================	
	 ...
	 */
	@Test
	public void article_Consumption_01_educationArticleHeaderChangeLanguage() {
	 ...
	 */
	@Test
	public void article_Consumption_01_educationArticleHeaderDownloadApp() {
		pages.desktopLandingPage.clickOnLineOneEducationLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_01_educationArticleHeaderLiveTv() {
		pages.desktopLandingPage.clickOnLineOneEducationLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_01_educationArticleHeaderSocialShare() {
		pages.desktopLandingPage.clickOnLineOneEducationLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_01_educationArticleHeaderTrendingTopics() {
		pages.desktopLandingPage.clickOnLineOneEducationLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_educationArticleHeaderLineOneSectionValidation () {
		pages.desktopLandingPage.clickOnLineOneEducationLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_educationArticleHeaderLineTwoSectionValidation () {
		pages.desktopLandingPage.clickOnLineOneEducationLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_educationArticleHeaderHamburgerMenuValidation () {
		pages.desktopLandingPage.clickOnLineOneEducationLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_educationArticleHeaderLineOneSectionArticleValidation () {
		pages.desktopLandingPage.clickOnLineOneEducationLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_educationArticleHeaderLineOneSectionSearchValidation () {
		pages.desktopLandingPage.clickOnLineOneEducationLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();

 ...
 */
public class DesktopEnglishPhotogalleryArticleBodyOpinionWidgetTest extends DesktopCommonConfig
{
	/**
	 * @author VipinKumarGawande
	 ...
	 */
	@Test
	public void photo_Consumption_04_opinionPhotogalleryArticleBreadcrumbNavigation()
	{
	 ...
	 */
	@Test
	public void photo_Consumption_05_opinionPhotogalleryArticleDetailedBoxValidation()
	{
		pages.desktopLandingPage.clickOnLineOneOpinionLink();
	 ...
	 */
	@Test
	public void photo_Consumption_05_opinionPhotogalleryArticleAgencyNavigation()
	{
		pages.desktopLandingPage.clickOnLineOneOpinionLink();
	 ...
	 */
	@Test
	public void photo_Consumption_05_opinionPhotogalleryArticleImageDescriptionValidation()
	{
		pages.desktopLandingPage.clickOnLineOneOpinionLink();
	 ...
	 */
	@Test
	public void photo_Consumption_05_opinionPhotogalleryArticleSocialMediaShareIconNavigation()
	{
		pages.desktopLandingPage.clickOnLineOneOpinionLink();
	 ...
	 */
	@Test
	public void photo_Consumption_05_opinionPhotogalleryArticleImageSocialMediaIconNavigation()
	{
		pages.desktopLandingPage.clickOnLineOneOpinionLink();
	 ...
	 */
	@Test
	public void photo_Consumption_07_opinionPhotogalleryArticleBodyTaboolaValidation()
	{
		pages.desktopLandingPage.clickOnLineOneOpinionLink();
	 ...
	 */
	@Test
	public void photo_Consumption_12_opinionPhotogalleryArticleRHSTaboolaValidation()
	{
		pages.desktopLandingPage.clickOnLineOneOpinionLink();
	...
	{
		pages.desktopLandingPage.clickOnLineOneOpinionLink();
		pages.desktopphotoGalleryConsumptionPage.verifyOpinionSectionPhotoArticleCountValidation(serverType);
	}
	 ...
	 */
	@Test
	public void photo_Consumption_08_OpinionSectionPhotoArticleTopRHSAdsValidation()
	{
		pages.desktopLandingPage.clickOnLineOneOpinionLink();
		pages.desktopphotoGalleryConsumptionPage.verifyOpinionSectionPhotoArticleTopRhsAdsValidation(serverType);
	}
	...
	{
		pages.desktopLandingPage.clickOnLineOneOpinionLink();
		pages.desktopphotoGalleryConsumptionPage.verifyOpinionSectionPhotoAdsBetweenArticleValidation(serverType);
	}

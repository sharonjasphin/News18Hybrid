 ...
 */
public class DesktopEnglishLiveBlogArticleHeaderBuzzValidationTest extends DesktopCommonConfig {
...
//======================================Article================================================	
	 ...
	 */
	@Test
	public void article_Consumption_01_buzzArticleHeaderChangeLanguage() {
	 ...
	 */
	@Test
	public void article_Consumption_01_buzzArticleHeaderDownloadApp() {
		pages.desktopLandingPage.clickOnLineOneBuzzLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_01_buzzArticleHeaderLiveTv() {
		pages.desktopLandingPage.clickOnLineOneBuzzLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_01_buzzArticleHeaderSocialShare() {
		pages.desktopLandingPage.clickOnLineOneBuzzLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_01_buzzArticleHeaderTrendingTopics() {
		pages.desktopLandingPage.clickOnLineOneBuzzLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_buzzArticleHeaderLineOneSectionValidation () {
		pages.desktopLandingPage.clickOnLineOneBuzzLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_03_buzzArticleHeaderLineTwoSectionValidation () {
		pages.desktopLandingPage.clickOnLineOneBuzzLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_buzzArticleHeaderHamburgerMenuValidation () {
		pages.desktopLandingPage.clickOnLineOneBuzzLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_buzzArticleHeaderLineOneSectionArticleValidation () {
		pages.desktopLandingPage.clickOnLineOneBuzzLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_buzzArticleHeaderLineOneSectionSearchValidation () {
		pages.desktopLandingPage.clickOnLineOneBuzzLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();

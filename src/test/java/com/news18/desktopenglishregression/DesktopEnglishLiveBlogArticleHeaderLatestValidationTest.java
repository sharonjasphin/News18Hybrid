 ...
 */
public class DesktopEnglishLiveBlogArticleHeaderLatestValidationTest extends DesktopCommonConfig {
...
//======================================Article================================================	
	 ...
	 */
	@Test
	public void article_Consumption_01_latestArticleHeaderChangeLanguage() {
	 ...
	 */
	@Test
	public void article_Consumption_01_latestArticleHeaderDownloadApp() {
		pages.desktopLandingPage.clickOnLineTwoLatestLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_01_latestArticleHeaderLiveTv() {
		pages.desktopLandingPage.clickOnLineTwoLatestLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_01_latestArticleHeaderSocialShare() {
		pages.desktopLandingPage.clickOnLineTwoLatestLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_01_latestArticleHeaderTrendingTopics() {
		pages.desktopLandingPage.clickOnLineTwoLatestLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_latestArticleHeaderLineOneSectionValidation () {
		pages.desktopLandingPage.clickOnLineTwoLatestLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_03_latestArticleHeaderLineTwoSectionValidation () {
		pages.desktopLandingPage.clickOnLineTwoLatestLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_latestArticleHeaderHamburgerMenuValidation () {
		pages.desktopLandingPage.clickOnLineTwoLatestLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_latestArticleHeaderLineOneSectionArticleValidation () {
		pages.desktopLandingPage.clickOnLineTwoLatestLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();
	 ...
	 */
	@Test
	public void article_Consumption_02_latestArticleHeaderLineOneSectionSearchValidation () {
		pages.desktopLandingPage.clickOnLineTwoLatestLink();
		pages.desktopArticleConsumptionPage.clickOnFirstLiveBlogArticle();

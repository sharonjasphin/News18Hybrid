 ...
 */
public class DesktopEnglishHomePageBodyIndiaWidget extends DesktopCommonConfig {
...
//	@BeforeMethod
	...
	public void verifyEnglishHomePageIndiaWidgetImg() {
		pages.desktopLandingPage.verifyIndiaWidgetImg(this.serverType);        
	}
	...
	public void verifyEnglishHomePageIndiaWidgetArticle() {
		pages.desktopLandingPage.verifyIndiaWidgetArticle(this.serverType);        
	}
	...
	public void verifyEnglishHomePageIndiaWidgetMoreLnk() {
		pages.desktopLandingPage.verifyMoreIndiaLnk(this.serverType);        
	}
